...
class Program(Base):
    ...
    weekly_price_usd = Column(Float, nullable=True)
    weekly_original_price_usd = Column(Float, nullable=True)
    monthly_price_usd = Column(Float, nullable=True)
    monthly_original_price_usd = Column(Float, nullable=True)
    yearly_price_usd = Column(Float, nullable=True)
    yearly_original_price_usd = Column(Float, nullable=True)
