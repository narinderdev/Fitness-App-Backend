...
def _program_payload(program: Program, preview_days: Iterable[ProgramDay] | None = None) -> dict:
    ...
    payload = ProgramResponse(
        ...
        weekly_price_usd=program.weekly_price_usd,
        weekly_original_price_usd=program.weekly_original_price_usd,
        monthly_price_usd=program.monthly_price_usd,
        monthly_original_price_usd=program.monthly_original_price_usd,
        yearly_price_usd=program.yearly_price_usd,
        yearly_original_price_usd=program.yearly_original_price_usd,
...
def create_program(
    ...
    try:
        ...
        program = Program(
            ...
            weekly_price_usd=body.weekly_price_usd,
            weekly_original_price_usd=body.weekly_original_price_usd,
            monthly_price_usd=body.monthly_price_usd,
            monthly_original_price_usd=body.monthly_original_price_usd,
            yearly_price_usd=body.yearly_price_usd,
            yearly_original_price_usd=body.yearly_original_price_usd,
